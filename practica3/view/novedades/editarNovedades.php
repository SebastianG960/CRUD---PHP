...
<body>
    <form action="../../controller/controladorNovedades.php" method="post">
        tipo:<input type="hidden" value="'.$data["id"].'" name="idNovedadesEditar"><input type="text" value="'.$data["tipo"].'" name="tipoNovedadesEditar"><br>
        novedad:<input type="text" value="'.$data["descnovedad"].'" name="NovedadesEditar"><br>
        <input type="submit" name="btnEditarNovedades">
