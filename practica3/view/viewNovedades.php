        ...
        while($data = $datos->fetch(PDO::FETCH_ASSOC)){
            ...
            <tbody>
                <tr>
                    ...
                    <form action='../controller/controladorNovedades.php'>
                        <td><a href='../controller/controladorNovedades.php?id=".$data['id']."&value=Borrar'><input type='button' name='btnBorrarNovedades' value='Borrar'></a></td>
                        <td><a href='../controller/controladorNovedades.php?id=".$data['id']."&value=Actualizar'><input type='button' name='btnActualizarNovedades' value='Actualizar'></a></td>
                    </form>
                </tr>
            </tbody>
            ");
